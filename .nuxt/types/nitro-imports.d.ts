...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/GitHub/lipeaks_fc_games/node_modules/nuxt/dist/core/runtime/nitro/utils/paths';
export { defineAppConfig } from 'D:/GitHub/lipeaks_fc_games/node_modules/nuxt/dist/core/runtime/nitro/utils/config';
export { defineSitemapEventHandler } from 'D:/GitHub/lipeaks_fc_games/node_modules/@nuxtjs/sitemap/dist/runtime/server/composables/defineSitemapEventHandler';
export { asSitemapUrl } from 'D:/GitHub/lipeaks_fc_games/node_modules/@nuxtjs/sitemap/dist/runtime/server/composables/asSitemapUrl';
export { defineI18nLocale, defineI18nConfig } from 'D:/GitHub/lipeaks_fc_games/node_modules/@nuxtjs/i18n/dist/runtime/composables/shared';
export { defineI18nLocaleDetector } from 'D:/GitHub/lipeaks_fc_games/node_modules/@nuxtjs/i18n/dist/runtime/composables/server';
export { getCookieLocale, getHeaderLanguage, getHeaderLanguages, getHeaderLocale, getHeaderLocales, getPathLocale, getQueryLocale, setCookieLocale, tryCookieLocale, tryHeaderLocale, tryHeaderLocales, tryPathLocale, tryQueryLocale } from 'D:/GitHub/lipeaks_fc_games/node_modules/@intlify/utils/dist/h3';
export { getSiteIndexable } from 'D:/GitHub/lipeaks_fc_games/node_modules/nuxt-site-config/dist/runtime/server/composables/getSiteIndexable';
export { updateSiteConfig } from 'D:/GitHub/lipeaks_fc_games/node_modules/nuxt-site-config/dist/runtime/server/composables/updateSiteConfig';
export { useNitroOrigin } from 'D:/GitHub/lipeaks_fc_games/node_modules/nuxt-site-config/dist/runtime/server/composables/useNitroOrigin';
export { useSiteConfig } from 'D:/GitHub/lipeaks_fc_games/node_modules/nuxt-site-config/dist/runtime/server/composables/useSiteConfig';
export { createSitePathResolver, withSiteTrailingSlash, withSiteUrl } from 'D:/GitHub/lipeaks_fc_games/node_modules/nuxt-site-config/dist/runtime/server/composables/utils';
export { getBotDetection, isBot, getBotInfo } from 'D:/GitHub/lipeaks_fc_games/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getBotDetection';
export { getPathRobotConfig } from 'D:/GitHub/lipeaks_fc_games/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getPathRobotConfig';
export { getSiteRobotConfig } from 'D:/GitHub/lipeaks_fc_games/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getSiteRobotConfig';
export { useRuntimeConfigNuxtRobots } from 'D:/GitHub/lipeaks_fc_games/node_modules/@nuxtjs/robots/dist/runtime/server/composables/useRuntimeConfigNuxtRobots';