...
export { useCategoryI18n } from '../src/composables/useCategoryI18n';
export { useGameI18n } from '../src/composables/useGameI18n';
export { useGameStats } from '../src/composables/useGameStats';
export { useExtendedI18n, useQuickI18n } from '../src/composables/useI18n';
export { useSEO } from '../src/composables/useSEO';
export { useVisitorStats } from '../src/composables/useVisitorStats';
export { default as browserCompatibility } from '../src/utils/browserCompatibility';
export { default as compatibilityTester } from '../src/utils/compatibilityTester';
export { isMobileDevice, isTouchDevice, getDeviceOrientation, getFCVirtualGamepadSettings, getMAMEVirtualGamepadSettings, getVirtualGamepadForCore } from '../src/utils/mobileDetection';
export { ModernEmulatorTester, ModernEmulatorTester, ModernBrowserChecker, ModernBrowserChecker, ModernPerformanceComparer, ModernPerformanceComparer, emulatorTester, browserChecker, performanceComparer } from '../src/utils/modernEmulatorUtils';
export { default as performanceComparison } from '../src/utils/performanceComparison';
export { useGameStore } from '../src/stores/game';
